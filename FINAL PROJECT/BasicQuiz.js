...
function MarkTheQuiz() {
    ...
    if (Q1 == 'patrick mahomes' || Q1 == 'mahomes' || Q1 == 'patrick m') {
        console.log('correct')
        score++;
    ...
    if (Q2 == 'atlanta flames' || Q2 == 'flames' || Q2 == 'atlanta') {
        console.log('correct')
        score++;
        percentage = percentage + 20;
    } else {
    ...
    if (Q3 == 'lebron james' || Q3 == 'james' || Q3 == 'lebron') {
        console.log('correct')
        score++;
        percentage = percentage + 20;
    } else {
    ...
    if (Q5 == 'cricket world cup' || Q5 == 'cwc') {
        console.log('correct')
        score++;
        percentage = percentage + 20;
    } else {
